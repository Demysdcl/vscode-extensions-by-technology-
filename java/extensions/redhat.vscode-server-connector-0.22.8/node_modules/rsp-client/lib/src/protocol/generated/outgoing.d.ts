...
export declare class Outgoing {
    ...
    */
    ...
    getDeployables(param: Protocol.ServerHandle, timeout?: number): Promise<Array<Protocol.DeployableState>>;
    listDeploymentOptions(param: Protocol.ServerHandle, timeout?: number): Promise<Protocol.Attributes>;
