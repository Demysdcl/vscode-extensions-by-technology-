...
class ObjectiveCRenderer extends ConvenienceRenderer_1.ConvenienceRenderer {
    constructor(targetLanguage, renderContext, _options) {
        ...
        this.emitExtraComments = (...comments) => {
        ...
        this.objcType = (t, nullableOrBoxed = false) => {
        ...
        this.fromDynamicExpression = (t, ...dynamic) => {
        ...
        this.toDynamicExpression = (t, typed) => {
        ...
        this.emitPropertyAssignment = (propertyName, jsonName, propertyType) => {
        ...
        this.emitPrivateClassInterface = (_, name) => {
        ...
        this.emitClassInterface = (t, className) => {
        ...
        this.emitClassImplementation = (t, className) => {
            const isTopLevel = collection_utils_1.mapContains(this.topLevels, t);
    ...
    emitSourceStructure(proposedFilename) {
        ...
        if (this._options.features.implementation) {
            ...
            if (!this._options.justTypes) {
                ...
                this.forEachNamedType("leading-and-interposing", this.emitPrivateClassInterface, () => null, () => null);
                if (this.haveEnums) {
                    if (this._options.extraComments) {
                        this.ensureBlankLine();
