...
export declare class PluginHost implements LSProvider, OnWatchFileChanges {
    ...
    getSemanticTokens(textDocument: TextDocumentIdentifier, range?: Range): Promise<SemanticTokens | null>;
