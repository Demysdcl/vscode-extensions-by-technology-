...
function registerCommands(commandHandler, context) {
    ...
    const newLocal = [
        ...
        vscode.commands.registerCommand('server.disconnectRSP', context => executeCommand(commandHandler.disconnectRSP, commandHandler, context, errorMessage.replace('%ACTION%', 'disconnect'))),
