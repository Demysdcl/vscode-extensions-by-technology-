...
export declare namespace Messages {
    ...
    namespace Server {
        ...
        namespace GetDeployablesRequest {
            const type: RequestType<Protocol.ServerHandle, Protocol.DeployableState[], void, void>;
        }
        /**
        ...
        namespace ListDeploymentOptionsRequest {
            const type: RequestType<Protocol.ServerHandle, Protocol.Attributes, void, void>;
        }
        /**
