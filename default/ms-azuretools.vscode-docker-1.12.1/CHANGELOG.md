...
* A new [API](https://github.com/microsoft/vscode-docker/raw/main/docs\api.md) has been added for other extensions to be able to control the "Add Docker Files to Workspace" functionality.
