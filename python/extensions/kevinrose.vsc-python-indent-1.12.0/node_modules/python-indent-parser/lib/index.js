...
function shouldHang(line, char) {
    ...
    // is in theRest
    neutralChars.forEach(function (c) { return theRest.delete(c); });
    var containsSomeChars = theRest.size > 0;
    fullChars.forEach(function (c) { return theRest.delete(c); });
    var containsOnlyFullChars = theRest.size === 0;
